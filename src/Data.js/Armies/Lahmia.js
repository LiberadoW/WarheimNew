...
export const lahmia = {
  heroes: {
    "Księżna Lahmi": {
      ...
      number: 1,
      equipmentList:
        heroEquipment["Nieumarły orszak księżnej Lahmi"].Bohaterowie,
      type: "Bohater",
      stats: {
        Początkowa: [5, 4, 4, 4, 4, 2, 8, 1, 8],
    ...
    Szkielet: {
      ...
      cost: 15,
      number: 15,
      equipmentList: heroEquipment["Nieumarły orszak księżnej Lahmi"].Stronnicy,
      type: "Stronnik",
      stats: {
    ...
    Gnilec: {
      ...
      rules: ["Głód trzewi", "Lot", "Nieumarły", "Potwór"],
    },
    Graveir: {
      id: 8,
      startingEquipment: ["Broń naturalna (zatruty atak)"],
  ...
  minModels: 3,
  maxModels: 15,
  name: "Nieumarły orszak księżnej Lahmi",
  nature: "Praworządna",
  armyRules: [
    "Kontakty handlowe (3)",
