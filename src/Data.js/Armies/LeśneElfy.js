...
export const leśne = {
  heroes: {
    ...
    "Jeździec Polany": {
      ...
      cost: 80,
      number: 3,
      equipmentList: heroEquipment["Leśni Elfowie z Athel Loren"].Jeździec,
      type: "Stronnik",
      stats: {
        Początkowa: [5, 4, 4, 3, 3, 1, 5, 1, 8],
        Maksymalna: [6, 7, 7, 4, 3, 3, 9, 4, 10],
    ...
    Drzewoduch: {
      ...
      type: "Stronnik",
      stats: {
        Początkowa: [3, 3, 0, 5, 5, 3, 3, 3, 8],
        Maksymalna: [3, 3, 0, 5, 5, 3, 3, 3, 8],
      },
      rules: [
        "Bycza szarża",
        "Duży cel",
    ...
    "Wielki orzeł": {
      ...
      rules: ["Lot", "Potwór", "Wierzchowiec", "Zwierzę"],
    },
    Rydwan: {
      id: 10,
      startingEquipment: [],
