...
export const psyWojny = {
  heroes: {
    ...
    "Oblężnik z Remas": {
      ...
      rules: ["Celny strzał", "Drużyna wsparcia", "Pawężnik", "Saper"],
    },
    Lansjer: {
      id: 7,
      startingEquipment: [
      ...
      cost: 70,
      number: 3,
      equipmentList: heroEquipment["Psy Wojny"].Lansjer,
      type: "Stronnik",
      stats: {
        Początkowa: [4, 3, 3, 3, 3, 1, 3, 1, 7],
        Maksymalna: [5, 6, 6, 4, 4, 3, 6, 4, 9],
    ...
    "Ptasznik z Catrazzy": {
      ...
      rules: ["Lot", "Ptasznik", "Ranger", "Zwiadowca"],
    },
    "Wóz bojowy": {
      id: 10,
      startingEquipment: [],
