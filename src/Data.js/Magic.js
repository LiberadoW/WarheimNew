export const magic = {
  "Tradycja Bestii": {
    ...
    w odległości do 8" od Bursztynowego Maga, również takie, które walczą wręcz. Dopóki
    zaklęcie 'pozostaje w grze' modele ignorują kary za poruszanie się po terenie trudnym, zaś
    ujemne modyfikatory za poruszanie się po terenie bardzo trudnym zmniejszone są o
    połowę (teren bardzo trudny należy traktować jako teren trudny). Modele mogą biegać po
    terenie trudnym lub terenie bardzo trudnym, a także wtedy, gdy pokonują przeszkody oraz
    ...
    Udane rzucenie zaklęcia oznacza, że model może wykonać zwykły ruch LOTU na
    ...
    4: [
      "5 SZPONY ORŁA",
      "RZUCONY NA 7+",
      `Szpony Orła są magicznym pociskiem o zasięgu 24”. Po udanym rzuceniu zaklęcia magiczny
    pocisk uderza w cel powodując trafienie o SILE 4 z cechą oręża PRECYZYJNE UDERZENIE`,
    ],
    5: [
      "6 SKÓRA DZIKA",
    ...
    6: [
      ...
      `Klątwa Ghur ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika, także związany walką wręcz (wybrany przez kierującego
    MAGIEM gracza bez ograniczeń, z wyjątkiem tego, że Magister Bursztynu musi widzieć
    swój cel). Dopóki zaklęcie 'pozostaje w grze' ofiara klątwy oraz wszystkie sprzymierzone
    z postacią modele w odległości do 4” traktowane są tak jakby poruszały się po terenie
    ...
    8: [
      "9 UCZTA KRUKÓW",
      "RZUCONY NA 11+",
      `Uczta Kruków jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”. Po
    ...
    Sztukmistrza, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 z cechą oręża
    ...
    z cechą oręża PRECYZYJNE UDERZENIEoraz premia +3 do SIŁYmaterializuje się w dłoni
    MAGA. Ponadto, Magister Bursztynu władający Ostrzem Ghur otrzymuje dodatkowy +1
    ATAK, a wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może
    korzystać tylko z Ostrza Ghur - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 GNIEW NIEDŹWIEDZIA",
    ...
    PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych), również związany walką wręcz.
    Cel zaklęcia staje się dziki i potężny niczym niedźwiedź. Uzyskuje zdolność broń
  ...
  "Tradycja Cienia": {
    1: [
      "1-2 SOBOWTÓR",
      "RZUCONY AUTOMATYCZNIE",
      `To zaklęcie musi zostać rzucone przed potyczką. MAG może rzucić czar na samego
    siebie lub dowolny sprzymierzony model bohatera lub stronnika. Zaklęcie można rzucić
    na PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych), który nie podlega zasadzie specjalnej
    NAJEMNE OSTRZE, CHORĄŻY, SYGNALISTA, DEMON, ISTOTA ETERYCZNA, LEŚNY
    DUCH, NIEUMARŁY, FANATYK, FURIA, NIENAWIŚĆ lub ZWIERZĘ.
    Objęty działaniem zaklęcia model podlega zasadzie specjalnej INFILTRACJA.`,
    ],
    2: [
      "3 KLĄTWA TAŃCA ROZPACZY",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Klątwa Tańca Rozpaczy ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Magister Cienia musi widzieć swój cel). Dopóki zaklęcie
    'pozostaje w grze' ofiara klątwy w ramach ruchów przymusowych w czasie rozgrywania fazy
    ruchu porusza się o K3” w losowo określonym kierunku (w przypadku gdy na Kostce
    Rozrzutu wypadnie wynik TRAFIENIE!, kierunek ruchu wybiera kierujący MAGIEM
    gracz). Jeżeli ruch oznaczałby wejście w kontakt z innym modelem, należy zatrzymać
    dotkniętą działaniem zaklęcia postać 1” od modelu.
    Model może znajdować się pod działaniem tylko jednej klątwy na raz.`,
    ],
    3: [
      "4 SKRZYDŁA Z CIENIA",
    ...
    4: [
      "5 SZTYLETY Z CIENIA",
      "RZUCONY NA 7+",
      `Sztylety z Cienia są magicznym pociskiem o zasięgu 24”. Po udanym rzuceniu zaklęcia
    ...
    odległości do 8" od Sztukmistrza. Objęte działaniem czaru modele mogą wykonać ruch
    ...
    6: [
      "7 KLĄTWA ULGU",
      "RZUCONY NA 10+",
      `Klątwa Ulgu ma zasięg 24”. Po udanym rzuceniu zaklęcia należy użyć 3” okrągłego
    wzornika i przykryć nim wybrany na cel model przeciwnika, także związany walką wręcz
    (wybrany przez kierującego MAGIEM gracza bez ograniczeń, z wyjątkiem tego, że
    Magister Cienia musi widzieć swój cel). Wszystkie modele (wrogie i sprzymierzone),
    ...
    się pod działanie zaklęcia na 4+. Do początku następnej fazy magii rzucającego zaklęcie
    MAGA objęte działaniem zaklęcia modele traktowane są tak jakby znajdowały się poza
    czasem. Ofiara klątwy nie może podejmować żadnej akcji i dryfuje bezczynnie w
    anomalii. Uwzględniając ten stan rzeczy w momencie określania czy drużyna musi
    wykonać test rozbicia, objęte działaniem zaklęcia modele nie są liczone do całkowitej
    liczby postaci w kompanii. Ponadto, należy zauważyć, że znajdujący się poza
    strumieniem czasu MAG lub DUCHOWNY lub KOWAL RUN nie może rzucać zaklęć,
    ponadto nie generuje Kostek Mocy oraz Kostek Rozproszenia.
    Model może znajdować się pod działaniem tylko jednej klątwy na raz`,
    ],
    7: [
      "8 ZAMĘT ULGU",
    ...
    sprzymierzone), których podstawki są całkowicie przykryte wzornikiem, zostają objęte
    działaniem zaklęcia automatycznie, te modele, których podstawki są częściowo
    przykryte, dostają się pod działanie zaklęcia na 4+. Dopóki zaklęcie 'pozostaje w grze'
    objęte działaniem klątwy modele podlegają zasadzie specjalnej GŁUPOTA.
    Model może znajdować się pod działaniem tylko jednej klątwy na raz.`,
    ],
    8: [
      "9 TANIEC CIENI",
      "RZUCONY NA 11+",
      `Taniec Cieni jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”. Po
    udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany
    na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których
    podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia
    automatycznie, te modele, których podstawki są częściowo przykryte, dostają się pod
    ...
    9: [
      ...
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Sztukmistrza, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 bez
    ...
    MAGA. Ponadto, Magister Cienia władający Ostrzem Ulgu otrzymuje dodatkowy +1
    ATAK, a wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może
    korzystać tylko z Ostrza Ulgu - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 NEGACJA ATAKU",
      "RZUCONY NA 15+",
      `Zaklęcie Negacja ataku jest czarem wyjątkowym, może zostać rzucone przez MAGA
    który odniósł obrażenia, został Oszołomiony!, Powalony na ziemię! a nawet został Wyłączony
    z akcji!. MAG może podjąć próbę rzucenia zaklęcia w następnej fazie magii (należy
    zignorować zasady według których Oszołomiony!, Powalony na ziemię! lub Wyłączony z akcji!
    MAG nie może rzucać zaklęć) i jeśli czar zostanie rzucony pomyślnie, moc zaklęcia
    neguje wszelkie obrażenia odniesione podczas poprzedniej tury tak, jakby rany nigdy
    nie zostały zadane – bo nie zostały zadane!`,
    ],
  },
  "Tradycja Metalu": {
    1: [
    ...
    dzierżonego przez bohaterów lub stronników i wybranego przez gracza oręża do walki
    wręcz. Do końca potyczki wszystkie rzuty na zranienie objętego działaniem zaklęcia oręża
    wykonywane są z dodatnim modyfikatorem +1. Ponadto, jeśli broń nie posiadała takiej
    cechy wcześniej, to zyskuje cechę oręża PRZEBICIE PANCERZA.`,
    ],
    2: [
      "3 KLĄTWA OŁOWIU",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Klątwa Ołowiu ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika, także związany walką wręcz (wybrany przez kierującego
    MAGIEM gracza bez ograniczeń, z wyjątkiem tego, że Magister Metalu musi widzieć swój
    cel). Dopóki zaklęcie 'pozostaje w grze' ofiary klątwy traci swoje dotychczasowe
    właściwości. Walczący przeklętym orężem model trafia jedynie w przypadku gdy
    wypadnie naturalny dublet w udanym rzucie na trafienie (żadne modyfikatory i zasady
    specjalnie nie mają zastosowania – liczy się jedynie naturalny dublet w udanym rzucie na
    trafienie), a udane trafienia mają SIŁĘ 1. Klątwa nie działa na broń magiczną oraz mechaniczną
    i runiczną.
    Model może znajdować się pod działaniem tylko jednej klątwy na raz.`,
    ],
    3: [
    ...
    4: [
      "5 DESTYLACJA PŁYNNEGO SREBRA",
      "RZUCONY NA 7+",
      `Sztylety cienia są magicznym pociskiem o zasięgu 24”. Po udanym rzuceniu zaklęcia magiczny
    pocisk uderza w cel powodując trafienie o SILE 4 z cechą oręża PŁONĄCY ATAK.`,
    ],
    5: [
      "6 METODA PRÓB & BŁĘDÓW",
      "RZUCONY NA 9+, POZOSTAJE W GRZE",
      `Moc zaklęcia oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące
    się w odległości do 8" od Alchemika, również takie, które walczą wręcz. Dopóki zaklęcie
    'pozostaje w grze' modele mogą przerzucić kostki w rzucie na trafienie, zranienie oraz
    Ochronę Pancerza i Ochronę Magiczną.`,
    ],
    6: [
      "7 KLĄTWA CHAMON",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Klątwa Chamon ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika, także związany walką wręcz (wybrany przez kierującego
    MAGIEM gracza bez ograniczeń, z wyjątkiem tego, że Magister Metalu musi widzieć swój
    cel). Dopóki zaklęcie 'pozostaje w grze' pancerz wroga, jego oręż i wyposażenie
    zmieniają się w ołów. Ofiara klątwy oraz wszystkie sprzymierzone z postacią modele w
    odległości do 4” muszą przerzucić wszystkie udane rzuty na trafienie oraz rzuty na
    Ochronę Pancerza.
    Model może znajdować się pod działaniem tylko jednej klątwy na raz.`,
    ],
    7: [
    ...
    8: [
      "9 SREBRZYSTE STRZAŁY ARHA",
      "RZUCONY NA 11+",
      `Srebrzyste strzały Archa są niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”.
    Po udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim
    wybrany na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone),
    których podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem
    zaklęcia automatycznie, te modele, których podstawki są częściowo przykryte, dostają
    się pod działanie zaklęcia na 4+. Objęte działaniem zaklęcia modele otrzymują trafienie
    o SILE 4 z cechą oręża PŁONĄCY ATAK.`,
    ],
    9: [
      "10 ZBROJA CHAMON",
      "RZUCONY NA 12+, POZOSTAJE W GRZE",
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Alchemika, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 z cechą oręża
    PŁONĄCY ATAK.`,
    ],
    10: [
      "11 OSTRZE CHAMON",
    ...
    Ponadto, Magister Metalu władający Ostrzem Chamon otrzymuje dodatkowy +1 ATAK, a
    wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może korzystać tylko
    z Ostrza Chamon - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 DUCH KUŹNI",
      "RZUCONY NA 14+",
      `Zaklęcie Duch Kuźni jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”.
    Po udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim
    wybrany na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone),
    których podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem
    zaklęcia automatycznie, te modele, których podstawki są częściowo przykryte, dostają
    się pod działanie zaklęcia na 4+. Objęte działaniem zaklęcia modele otrzymują trafienie
    o SILE 1, jeżeli nie dysponują Ochroną Pancerza; trafienie o SILE 2, jeżeli dysponują Ochroną
    Pancerza na 6+; trafienie o SILE 3, jeżeli dysponują Ochroną Pancerza na 5+; trafienie o SILE
    4, jeżeli dysponują Ochroną Pancerza na 4+; trafienie o SILE 5, jeżeli dysponują Ochroną
    Pancerza na 3+; trafienie o SILE 6, jeżeli dysponują Ochroną Pancerza na 2+ oraz trafienie o
    SILE 7, jeżeli dysponują Ochroną Pancerza na 1+ bądź lepszą z cechą oręża PŁONĄCY ATAK,
    bez możliwości skorzystania z Ochrony Pancerza.`,
    ],
  },
  "Tradycja Niebios": {
    1: [
      "1-2 ZWIASTUN PRZYSZŁOŚCI",
      "RZUCONY AUTOMATYCZNIE",
      `To zaklęcie musi zostać rzucone przed potyczką. MAG może rzucić czar na samego
    siebie lub dowolny sprzymierzony model bohatera lub stronnika. Zaklęcie można rzucić
    na PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych).
    Do końca potyczki model może przerzucić wszystkie nieudane rzuty na trafienie i
    zranienie. Nieudane rzuty na trafienie i zranienie uzyskane w przerzucie nie podlegają
    dalszemu przerzuceniu – nie można nigdy przerzucić już przerzuconych kostek.`,
    ],
    2: [
      "3 SZAFIROWY PORTAL",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Udane rzucenie zaklęcia tworzy magiczne wrota łączące dwa punkty na stole, które muszą
    znajdować się w odległości do 24” od MAGA. Wrota należy traktować jak ‘zwykłe’ drzwi, przez
    które model może wykonać ruch jak w fazie ruchu, który może być również ruchem
    szarży (szarża ta podlegać będzie wszystkim zasadom szarży, z wyjątkiem tego, że nie
    można próbować przejąć szarży modelu, który przekroczył szafirowy portal).`,
    ],
    3: [
      "4 NIEBIAŃSKIE SKRZYDŁA",
      "RZUCONY NA 7+",
      `MAG może rzucić zaklęcie na siebie lub dowolny sprzymierzony model bohatera lub
    stronnika w odległości do 8”, nawet jeśli go nie widzi. Zaklęcie można rzucić na PIESZY
    model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na modele na
    ...
    4: [
      "5 BŁYSKAWICA",
      "RZUCONY NA 7+",
      `Błyskawica to magiczny pocisk o zasięgu 24”. Po udanym rzuceniu zaklęcia magiczny pocisk
    uderza w cel powodując trafienie o SILE 4 bez możliwości skorzystania z Ochrony
    Pancerza.`,
    ],
    5: [
      ...
      `Zaklęcie oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się
    w odległości do 8" od Astromanty, również takie, które walczą wręcz. Dopóki zaklęcie
    'pozostaje w grze' broń objętych działaniem czaru modeli otrzymuje cechę oręża UDERZA
    JAKO PIERWSZY.`,
    ],
    6: [
      "7 KLĄTWA AZYR",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Klątwa Azyr ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Astromanta musi widzieć swój cel). Dopóki zaklęcie
    'pozostaje w grze' ofiara klątwy oraz wszystkie sprzymierzone z postacią modele w
    odległości do 4” mogą zostać obrane na cel czarów typu magiczny pocisk oraz ataków
    ...
    działaniem zaklęcia automatycznie, te modele, których podstawki są częściowo
    przykryte, dostają się pod działanie zaklęcia na 4+. Objęte działaniem czaru modele
    otrzymują trafienie o SILE 4 bez możliwości skorzystania z Ochrony Pancerza.`,
    ],
    8: [
      "9 PIORUN URANONA",
      "RZUCONY NA 11+",
      `Piorun Uranona jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”. Po
    udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany
    na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których
    podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia
    automatycznie, te modele, których podstawki są częściowo przykryte, dostają się pod
    ...
    9: [
      ...
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Astromanty, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 bez
    możliwości skorzystania z Ochrony Pancerza.`,
    ],
    10: [
      "11 OSTRZE AZYR",
    ...
    MAGA. Ponadto, Magister Niebios władający Ostrzem Azyr otrzymuje dodatkowy +1
    ATAK, a wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może
    korzystać tylko z Ostrza Azyr - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 KLĄTWA FATUM",
  ...
  "Tradycja Ognia": {
    1: [
      "1-2 GOREJĄCY MIECZ RHUIN",
      "RZUCONY AUTOMATYCZNIE",
      `To zaklęcie musi zostać rzucone przed potyczką. Moc zaklęcia oddziałuje na K3 sztuki,
    dzierżonego przez bohaterów lub stronników i wybranego przez gracza oręża do walki
    wręcz. Do końca potyczki broń zyskuje cechę oręża PŁONĄCY ATAK.`,
    ],
    2: [
      "3 PŁOMIENNA KLĄTWA",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Płomienna klątwa ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Piromanta musi widzieć swój cel). Dopóki zaklęcie
    ...
    4: [
      "5 OGIEŃ U’ZHUL",
      "RZUCONY NA 7+",
      `Ogień U’zhul to magiczny pocisk o zasięgu 24”. Po udanym rzuceniu zaklęcia magiczny pocisk
    uderza w cel powodując trafienie o SILE 4 z cechą oręża PŁONĄCY ATAK.`,
    ],
    5: [
      "6 POTĘGA AQSHY",
      "RZUCONY NA 8+, POZOSTAJE W GRZE",
      `Zaklęcie oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się
    w odległości do 8" od Piromanty, również takie, które walczą wręcz. Dopóki zaklęcie
    'pozostaje w grze' broń objętych działaniem czaru modeli otrzymuje cechę oręża
    PŁONĄCY ATAK.`,
    ],
    6: [
      "7 KLĄTWA AQSHY",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Klątwa Aqshy ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Piromanta musi widzieć swój cel). Dopóki zaklęcie
    'pozostaje w grze' ofiara klątwy oraz wszystkie sprzymierzone z postacią modele w
    ...
    8: [
      "9 OGNISTA KULA",
      "RZUCONY NA 11+",
      `Ognista Kula jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”. Po
    udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany
    na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których
    podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia
    automatycznie, te modele, których podstawki są częściowo przykryte, dostają się pod
    ...
    9: [
      ...
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Piromanty, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 z cechą oręża
    PŁONĄCY ATAK.`,
    ],
    10: [
      "11 OSTRZE AQSHY",
      ...
      `MAG może rzucić zaklęcie na siebie. Dopóki zaklęcie ‘pozostaje w grze’ magiczne ostrze
    z cechą oręża PŁONĄCY ATAK oraz premia +3 do SIŁY materializuje się w dłoni MAGA.
    Ponadto, Magister Ognia władający Ostrzem Aqshy otrzymuje dodatkowy +1 ATAK, a
    wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może korzystać tylko
    z Ostrza Aqshy - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 OGNISTE ODRODZENIE FENIKSA",
      "RZUCONY NA 14+, POZOSTAJE W GRZE",
      `Jeśli w trakcie rozgrywania potyczki Magister Ognia zostanie Wyłączony z akcji!, a zaklęcie
    'pozostaje w grze', należy użyć 3” okrągłego wzornika i przykryć nim model MAGA.
    ...
    podstawki są częściowo przykryte, dostają się pod działanie zaklęcia na 4+ (za
    wyjątkiem samego rzucającego!). Objęte działaniem zaklęcia modele otrzymują trafienie
    o SILE 4 z cechą oręża PŁONĄCY ATAK.
    W najbliższej fazie ruchu model MAGA powstaje podczas wykonywania pozostałych
    ruchów, tak jak postać która była Oszołomiona!. Magister Aqshy może wykonać ruch (ale
    nie bieg), rzucać zaklęcia oraz strzelać. Jeśli model pozostaje związany walką wręcz to
    ...
    Piromantę należy traktować tak, jakby wciąż posiadał 1 punkt ŻW.`,
    ],
  },
  "Tradycja Śmierci": {
    1: [
      "1-2 ŚMIECH ŻNIWIARZA",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `To zaklęcie musi zostać rzucone przed potyczką. MAG może rzucić czar na samego
    siebie lub dowolny sprzymierzony model bohatera lub stronnika. Zaklęcie można rzucić
    na PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych).
    Objęty działaniem zaklęcia model podlega zasadzie specjalnej STRACH i
    ZIMNOKRWISTY.`,
    ],
    2: [
      "3 KLĄTWA ROZPACZY",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Klątwa Rozpaczy ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Magister Śmierci musi widzieć swój cel). Dopóki zaklęcie
    ...
    4: [
      "5 POSŁANIEC ŚMIERCI",
      "RZUCONY NA 7+",
      `Posłaniec Śmierci jest magicznym pociskiem o zasięgu 24”. Po udanym rzuceniu zaklęcia
    magiczny pocisk uderza w cel powodując trafienie o SILE 4 z cechą oręża DRUZGOCZĄCY.`,
    ],
    5: [
      "6 AKCEPTACJA PRZEZNACZENIA",
      "RZUCONY NA 8+, POZOSTAJE W GRZE",
      `MAG może rzucić to zaklęcie na siebie lub dowolny sprzymierzony model bohatera lub
    stronnika w odległości do 8”, nawet jeśli go nie widzi. Zaklęcie można rzucić na PIESZY
    model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na modele na
    podstawkach 40x40 mm i większych), również związany walką wręcz.
    Udane rzucenie czaru oznacza, że model podlega zasadzie specjalnej NIEZŁOMNOŚĆ.`,
    ],
    6: [
      "7 KLĄTWA SHYISH",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Klątwa Shyish ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Magister Śmierci musi widzieć swój cel). Po udanym
    rzuceniu zaklęcia należy umieścić obok ofiary czaru sześciościenną kostkę, tak aby
    wskazywała wynik ‘1’. Dopóki zaklęcie 'pozostaje w grze', na początku każdej kolejnej
    fazy magii MAGA należy obracać kostkę tak, by wskazywała wynik o +1 większy. Wynik
    na kostce oznacza ujemny modyfikator do współczynników SZ, S i WT jaki otrzymuje
    ofiara klątwy oraz wszystkie sprzymierzone z postacią modele w odległości do 8”.
    ...
    7: [
      "8 KRĄG ŚMIERCI",
      "RZUCONY NA 11+, POZOSTAJE W GRZE",
      `Po udanym rzuceniu zaklęcia kierujący MAGIEM gracz wybiera dowolny, niezajęty przez
    wrogie modele, obszar na powierzchni stołu, który należy przykryć 3” okrągłym
    wzornikiem. Dopóki zaklęcie pozostaje w grze modele podlegające zasadzie specjalnej
    NIEUMARŁY traktują teren przykryty wzornikiem jako teren niedostępny.`,
    ],
    8: [
      "9 KOSA ŻNIWIARZA",
      "RZUCONY NA 11+",
      `Kosa Żniwiarza jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”. Po
    udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany
    na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których
    podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia
    automatycznie, te modele, których podstawki są częściowo przykryte, dostają się pod
    ...
    9: [
      ...
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Magistra Shyish, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 z cechą oręża
    DRUZGOCZĄCY.`,
    ],
    10: [
      "11 OSTRZE SHYISH",
    ...
    Ponadto, Magister Śmierci władający Ostrzem Shyish otrzymuje dodatkowy +1 ATAK, a
    wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może korzystać tylko
    z Ostrza Shyish - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 KLĄTWA CZARNEGO HUMORU",
      "RZUCONY NA 13+, POZOSTAJE W GRZE",
      `Klątwa Shyish ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Magister Śmierci musi widzieć swój cel). Ofiara klątwy
    zostaje Powalona na ziemię! i upada zanosząc się upiornym, histerycznym śmiechem. By
    ustalić czy ofiara zaklęcia ‘pęknie ze śmiechu’, obydwaj gracze rzucają natychmiast K6.
    Jeżeli gracz, którego MAG rzucał zaklęcie uzyska wynik równy bądź niższy od
    przeciwnika, model dalej zanosi się śmiechem i w następnej turze wciąż traktowany jest
    jako Powalony na ziemię!, jeżeli jednak uzyska wynik wyższy od przeciwnika, model ‘pęka
    ze śmiechu’ i zostaje Wyłączony z akcji!. Gracze rzucają K6 i powtarzają całą procedurę
    w każdej fazie magii, póki gracz dowodzący magiem nie uzyska wyniku wyższego od
    przeciwnika lub klątwa nie zostanie rozproszona.
    Model może znajdować się pod działaniem tylko jednej klątwy na raz.`,
    ],
  },
  "Tradycja Światła": {
    ...
    na PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych).
    Objęty działaniem zaklęcia model podlega zasadzie specjalnej NIEZŁOMNOŚĆ i
    ZIMNOKRWISTY.`,
    ],
    2: [
      "3 STRAŻNICZE ŚWIATŁO",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Zaklęcie oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się
    w odległości do 8" od Hierofanty, również takie, które walczą wręcz. Dopóki zaklęcie
    'pozostaje w grze' modele pozostające w zasięgu działania zaklęcia mogą przerzucić
    każdy nieudany test STRACHU lub GROZY.`,
    ],
    3: [
      "4 ŚWIETLISTE SKRZYDŁA",
      "RZUCONY NA 7+",
      `MAG może rzucić zaklęcie na siebie lub dowolny sprzymierzony model bohatera lub
    stronnika w odległości do 8”, nawet jeśli go nie widzi. Zaklęcie można rzucić na PIESZY
    model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na modele na
    ...
    4: [
      "5 PŁONĄCE WEJRZENIE",
      "RZUCONY NA 7+",
      `Płonące Wejrzenie jest magicznym pociskiem o zasięgu 24”. Po udanym rzuceniu zaklęcia
    magiczny pocisk uderza w cel powodując trafienie o SILE 4 z cechą oręża PRECYZYJNE
    UDERZENIE. Istoty NIEUMARŁE, ETERYCZNE, LEŚNE DUCHY oraz DEMONY i
    OPĘTANI otrzymują trafienie o SILE 6 z cechą oręża PRECYZYJNE UDERZENIE.`,
    ],
    5: [
      "6 SIEĆ AMYNTHOKA",
      "RZUCONY NA 9+, POZOSTAJE W GRZE",
      `Sieć Amynthoka ma zasięg 24” i może zostać rzucona na dowolny model przeciwnika,
    również związany walką wręcz, który znajduje się w polu widzenia MAGA. Po udanym
    rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany na cel model
    przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których podstawki są całkowicie
    ...
    Dopóki zaklęcie ‘pozostaje w grze’ objęte działaniem klątwy modele podlegają zasadzie
    specjalnej GŁUPOTA. Istoty NIEUMARŁE, ETERYCZNE, LEŚNE DUCHY oraz DEMONY i
    OPĘTANI przeprowadzając test GŁUPOTY wykonują rzut 3K6 odrzucając kostkę z
    najniższym wynikiem.
    Model może znajdować się pod działaniem tylko jednej klątwy na raz.`,
    ],
    6: [
      "7 KLĄTWA HYSH",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Klątwa Hysh ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Magister Światła musi widzieć swój cel). Dopóki
    zaklęcie 'pozostaje w grze' ofiara klątwy oraz wszystkie sprzymierzone z postacią modele
    w odległości do 4” nie mogą się UKRYĆ oraz korzystać z osłon.
    Model może znajdować się pod działaniem tylko jednej klątwy na raz.`,
    ],
    7: [
      "8 OCHRONA PHA",
    ...
    wrogie modele, obszar na powierzchni stołu, który należy przykryć 3” okrągłym
    wzornikiem. Dopóki zaklęcie pozostaje w grze modele podlegające zasadzie specjalnej
    NIEUMARŁY, ETERYCZNY, LEŚNE DUCHU oraz DEMONY i OPĘTANI traktują teren
    przykryty wzornikiem jako teren niedostępny.`,
    ],
    8: [
      "9 KOLUMNA ŚWIATŁOŚCI",
      "RZUCONY NA 11+",
      `Kolumna Światłości jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”. Po
    udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany na
    cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których podstawki są
    całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia automatycznie, te
    modele, których podstawki są częściowo przykryte, dostają się pod działanie zaklęcia na
    4+. Objęte działaniem zaklęcia modele otrzymują trafienie o SILE 4 z cechą oręża
    PRECYZYJNE UDERZENIE. Istoty NIEUMARŁE, ETERYCZNE, LEŚNE DUCHY oraz
    DEMONY i OPĘTANI otrzymują trafienie o SILE 6 z cechą oręża PRECYZYJNE UDERZENIE.`,
    ],
    9: [
      "10 ZBROJA HYSH",
      "RZUCONY NA 12+, POZOSTAJE W GRZE",
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Hierofanty, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 z cechą oręża
    PRECYZYJNE UDERZENIE. Istoty NIEUMARŁE, ETERYCZNE, LEŚNE DUCHY oraz
    DEMONY i OPĘTANI otrzymują trafienie o SILE 6 z cechą oręża PRECYZYJNE UDERZENIE.`,
    ],
    10: [
    ...
    MAGA. Ponadto, Magister Światła władający Ostrzem Hysh otrzymuje dodatkowy +1
    ATAK, a wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może
    korzystać tylko z Ostrza Hysh - magicznego oręża nie można łączyć z inną bronią. Ostrze
    Hysh użyte przeciwko istotom NIEUMARŁYM, ETERYCZNYM, LEŚNYM DUCHOM oraz
    DEMONOM i OPĘTANYM zyskuje cechę oręża DRUZGOCZĄCY.`,
    ],
    11: [
      "12 ŚWIĘTA TARCZA IGNATUSA",
      "RZUCONY NA 15+, POZOSTAJE W GRZE",
      `Zaklęcie oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się w
    odległości do 8" od Hierofanty, również takie, które walczą wręcz. Dopóki zaklęcie 'pozostaje
    w grze' modele pozostające w zasięgu działania zaklęcia otrzymują Magiczną Ochronę na 4+,
    ponadto wrogie postacie atakujące modele chronione Świętą Tarczą Ignatusa otrzymują
    modyfikator -1 do rzutu na trafienie. Istoty NIEUMARŁE, ETERYCZNE, LEŚNE DUCHY oraz
    DEMONY i OPĘTANI trafiają objęte działaniem zaklęcia modele jedynie w przypadku gdy
    wypadnie naturalny dublet w udanym rzucie na trafienie (żadne modyfikatory i zasady
    specjalnie nie mają zastosowania – liczy się jedynie naturalny dublet w udanym rzucie na
    trafienie).`,
    ],
  ...
  "Tradycja Życia": {
    ...
    na PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych).
    Objęty działaniem zaklęcia model podlega zasadzie specjalnej REGENERACJA.`,
    ],
    2: [
      "3 WROTA ZIEMI",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Udane rzucenie zaklęcia tworzy Wrota Ziemi łączące dwa punkty na stole, które muszą
    ...
    że nie można próbować przejąć szarży modelu, który przekroczył Wrota Ziemi).`,
    ],
    3: [
      "4 SKRZYDŁA SOWY",
      "RZUCONY NA 7+",
    ...
    4: [
      "5 CIERŃ",
      "RZUCONY NA 7+",
      `Cierń jest magicznym pociskiem o zasięgu 24”. Po udanym rzuceniu zaklęcia magiczny pocisk
    uderza w cel powodując trafienie o SILE 4 z cechą oręża DRUZGOCZĄCY.`,
    ],
    5: [
      "6 ZWIERCIADŁO BÓLU",
      "RZUCONY NA 9+, POZOSTAJE W GRZE",
    ...
    model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na modele na
    podstawkach 40x40 mm i większych), również związany walką wręcz.
    Dopóki zaklęcie 'pozostaje w grze' wrogie modele które zaatakują i wykonają
    udany rzut na trafienie otrzymują trafienie z taką samą SIŁĄ i właściwościami jak cios,
    który zadały.`,
    ],
    6: [
      "7 KLĄTWA GHYRAN",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Klątwa Ghyran ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Magister Życia musi widzieć swój cel). Dopóki zaklęcie
    'pozostaje w grze' ofiara klątwy oraz wszystkie sprzymierzone z postacią modele w
    odległości do 4” nie mogą biegać, ponadto wartość współczynnika SZ zostaje
    zmniejszona o połowę (ewentualne ułamki należy zaokrąglić w górę). Modele
    podlegające zasadzie specjalnej LOT, nie mogą latać i biegać, jednak wartość ich
    ...
    8: [
      "9 GRAD KAMIENI",
      "RZUCONY NA 11+",
      `Grad Kamieni jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”. Po
    udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany
    na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których
    podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia
    automatycznie, te modele, których podstawki są częściowo przykryte, dostają się pod
    działanie zaklęcia na 4+. Objęte działaniem zaklęcia modele otrzymują trafienie o SILE
    4 z cechą oręża z cechą oręża DRUZGOCZĄCY.`,
    ],
    9: [
      "10 ZBROJA GHYRAN",
      "RZUCONY NA 12+, POZOSTAJE W GRZE",
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+, a wrogie
    modele które zaatakują Magistra Jadeitu i wykonają udany rzut na trafienie otrzymują
    ...
    10: [
      ...
      `MAG może rzucić zaklęcie na siebie. Dopóki zaklęcie ‘pozostaje w grze’ magiczne ostrze
    z cechą oręża DRUZGOCZĄCY oraz premia +3 do SIŁY materializuje się w dłoni MAGA.
    Ponadto, Magister Życia władający Ostrzem Ghyran otrzymuje dodatkowy +1 ATAK, a
    wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może korzystać tylko
    z Ostrza Ghyran - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 DAR ŻYCIA",
      "RZUCONY NA 14+",
      `MAG może rzucić zaklęcie na dowolny sprzymierzony model bohatera lub stronnika,
    który został Wyłączony z akcji!. Udane rzucenie sprawia, że model odzyskuje wszystkie
    utracone punkty ŻW i kontynuuje turę normalnie. W przypadku modeli dosiadających
    POTWORA, gracz musi wybrać pomiędzy WIERZCHOWCEM, a KAWALERZYSTĄ.
    Zaklęcie nie działa na istoty NIEUMARŁE, ETERYCZNE, LEŚNE DUCHY oraz
    DEMONY i OPĘTANYCH, MACHINY WOJENNE.`,
    ],
  },
  "Tradycja Lodu": {
    1: [
    ...
    na PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych).
    Do końca potyczki objęty działaniem zaklęcia model w każdej fazie walki wręcz
    ...
    2: [
      ...
      "RZUCONY NA 8+, POZOSTAJE W GRZE",
      `Zaklęcie oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się
    w odległości do 8" od Magistra Lodu, również takie, które walczą wręcz. Dopóki zaklęcie
    'pozostaje w grze' modele pozostające w zasięgu działania zaklęcia otrzymują Magiczną
    Ochronę na 4+ przeciwko zwykłym i magicznym pociskom.`,
    ],
    3: [
      "4 SKRZYDŁA MISKI",
      "RZUCONY NA 8+",
    ...
    4: [
      "5 LODOWE GROTY",
      "RZUCONY NA 7+",
      `Lodowe groty są magicznym pociskiem o zasięgu 24”. Po udanym rzuceniu zaklęcia magiczny
    pocisk uderza w cel powodując trafienie o SILE 4 bez możliwości skorzystania z Ochrony
    Pancerza.`,
    ],
    5: [
      "6 ZAWODZĄCY WIATR",
      ...
      `Zaklęcie oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się
    w odległości do 8" od Magistra Lodu, również takie, które walczą wręcz. Dopóki zaklęcie
    'pozostaje w grze' modele objęte działaniem zaklęcia Zawodzący Wiatr nie mogą być
    obrane na cel strzelania z broni dystansowej o SILE 4 lub mniej. Moc zaklęcia nie obejmuje
    swym działaniem MACHIN WOJENNYCH, które mogą strzelać do dotkniętego jego
    działaniem obszaru w zwykły sposób.`,
    ],
    6: [
      "7 KLĄTWA MISKI",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Klątwa Miski ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika (wybrany przez kierującego MAGIEM gracza bez
    ograniczeń, z wyjątkiem tego, że Magister Lodu musi widzieć swój cel). Po udanym
    rzuceniu zaklęcia należy umieścić obok ofiary czaru sześciościenną kostkę, tak aby
    wskazywała wynik ‘1’. Dopóki zaklęcie 'pozostaje w grze', na początku każdej kolejnej
    fazy magii MAGA należy obracać kostkę tak, by wskazywała wynik o +1 większy. Wynik
    na kostce oznacza ujemny modyfikator do współczynników SZ, S i WT jaki otrzymuje
    ...
    8: [
      "9 LODOWY WIATR",
      "RZUCONY NA 11+",
      `Lodowy Wiatr jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”. Po
    udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany
    na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których
    podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia
    automatycznie, te modele, których podstawki są częściowo przykryte, dostają się pod
    ...
    9: [
      ...
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Magistra Lodu, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 bez
    możliwości skorzystania z Ochrony Pancerza.`,
    ],
    10: [
      "11 OSTRZE MISKI",
      ...
      `MAG może rzucić zaklęcie na siebie. Dopóki zaklęcie ‘pozostaje w grze’ magiczne ostrze
    z cechą oręża PRZEBICIE PANCERZA oraz premia +3 do SIŁY materializuje się w dłoni
    MAGA. Ponadto, Magister Lodu władający Ostrzem Miski otrzymuje dodatkowy +1
    ATAK, a wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może
    korzystać tylko z Ostrza Miski - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 GNIEW URSUNA",
      "RZUCONY NA 13+, POZOSTAJE W GRZE",
      `MAG może rzucić zaklęcie na siebie lub też na dowolnego, sprzymierzonego bohatera
    lub stronnika w odległości do 8”, nawet jeśli go nie widzi. Czar może zostać rzucony na
    PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych), również związany walką wręcz.
    Cel zaklęcia staje się dziki i potężny niczym niedźwiedź. Uzyskuje zdolność broń
    naturalna, +3 ATAKI, +2 do SIŁY oraz +1 do WT. Model pozostający pod wpływem
  ...
  "Magia Żywiołów": {
    1: [
      "1-2 PIERWSZE ŻYCZENIE IBN JELLABA",
      "RZUCONY AUTOMATYCZNIE",
      `Zaklęcie musi zostać rzucone przed potyczką. Moc zaklęcia pozwala wpływać geniusom
    na przebieg rozgrywki. Na początku potyczki, przed turą pierwszego gracza należy zebrać
    pulę Kostek Przeznaczenia. Pula składa się z K3 kostek K6. Po ustalenie puli Kostek
    Przeznaczenia gracz wykonuje rzut.
    ...
    model bohatera. Wykorzystany WYNIK należy usunąć z puli WYNIKÓW Kostek
    Przeznaczenia. WYNIKI, które nie zostaną wykorzystane w trakcie potyczki przepadają i
    nie mogą być użyte w czasie rozgrywania sekwencji po potyczce.`,
    ],
    2: [
      "3 WROTA DAO",
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Udane rzucenie zaklęcia tworzy Wrota Dao łączące dwa punkty na stole, które muszą
    znajdować się w odległości do 18” od MAGA. Wrota należy traktować jak ‘zwykłe’
    drzwi, przez które model może wykonać ruch jak w fazie ruchu, który może być również
    ruchem szarży (szarża ta podlegać będzie wszystkim zasadom szarży, z wyjątkiem tego,
    że nie można próbować przejąć szarży modelu, który przekroczył Wrota Dao).`,
    ],
    3: [
      "4 SKRZYDŁA DŻINNA",
      "RZUCONY NA 8+",
    ...
    4: [
      "5 OGIEŃ IFRYTA",
      "RZUCONY NA 7+",
      `Ogień Ifryta to magiczny pocisk o zasięgu 18”. Po udanym rzuceniu zaklęcia magiczny pocisk
    uderza w cel powodując trafienie o SILE 4 z cechą oręża PŁONĄCY ATAK.`,
    ],
    5: [
      "6 MIRAŻ MARIDY",
      "RZUCONY NA 9 +, POZOSTAJE W GRZE",
      `Czar oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się w
    odległości do 12" od Wezyra. Dopóki zaklęcie 'pozostaje w grze' modele wydają się
    znajdować kilka kroków od prawdziwej pozycji, a wszystkie ataki (zarówno w fazie
    strzelania jak i w fazie walki wręcz) wymierzone w objęte działaniem zaklęcia modele
    wykonywane są z karą -1 do rzutu na trafienie.`,
    ],
    6: [
      "7 DRUGIE ŻYCZENIE AL MUKTARA",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Drugie Życzenie ma zasięg 18”. Po udanym rzuceniu zaklęcia należy użyć 3” okrągłego
    wzornika i przykryć nim wybrany na cel model przeciwnika, także związany walką wręcz
    (wybrany przez kierującego MAGIEM gracza bez ograniczeń, z wyjątkiem tego, że
    ...
    8: [
      "9 PIĘŚĆ MARIDY",
      "RZUCONY NA 11+",
      `Pięść Maridy jest niezwykle niebezpiecznym magicznym pociskiem o zasięgu 18”. Po
    udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim wybrany
    na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone), których
    podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia
    automatycznie, te modele, których podstawki są częściowo przykryte, dostają się pod
    ...
    9: [
      ...
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Wezyra, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 z cechą oręża
    PŁONĄCY ATAK.`,
    ],
    10: [
      "11 OSTRZE DŻINNÓW",
      ...
      `MAG może rzucić zaklęcie na siebie. Dopóki zaklęcie ‘pozostaje w grze’ magiczne ostrze
    z cechą oręża UDERZA JAKO PIERWSZY oraz premia +3 do SIŁY materializuje się w dłoni
    MAGA. Ponadto, Wezyr władający Ostrzem Dżinnów otrzymuje dodatkowy +1 ATAK, a
    wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może korzystać tylko
    z Ostrza Dżinnów - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 TRZECIE ŻYCZENIE SUŁTANA JAFFARA",
      "RZUCONY NA 15+, POZOSTAJE W GRZE",
  ...
  "Magia Asrai": {
    1: [
      ...
      `MAG może rzucić to zaklęcie na siebie lub też na dowolnego, sprzymierzonego bohatera
    lub stronnika w odległości do 12”, nawet jeśli go nie widzi. Czar może zostać rzucony
    na PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych), również związany walką wręcz.
    Dopóki zaklęcie 'pozostaje w grze' modele traktują na potrzeby ruchu (ale nie pola
    ...
    2: [
      ...
      "RZUCONY NA 7+, POZOSTAJE W GRZE",
      `Czar oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się w
    odległości do 12" od Maga Leśnych Elfów, również związane walką wręcz.
    Dopóki zaklęcie 'pozostaje w grze' modele wydają się znajdować kilka kroków od
    ...
    4: [
      "5 DRZAZGA",
      "RZUCONY NA 7+",
      `Drzazga jest magicznym pociskiem o zasięgu 24”. Po udanym rzuceniu zaklęcia magiczny
    pocisk uderza w cel powodując trafienie o SILE 4 z cechą oręża PRECYZYJNE UDERZENIE.`,
    ],
    5: [
      "6 WIDMOWY RUCH",
      "RZUCONY NA 9+",
      `Czar oddziałuje na model MAGA i wszystkie sprzymierzone modele znajdujące się w
    odległości do 12" od Maga Leśnych Elfów. Objęte działaniem czaru modele mogą
    wykonać ruch jak w fazie ruchu, który może być również ruchem szarży (szarża ta
    podlegać będzie wszystkim zasadom szarży, z wyjątkiem tego, że nie można próbować
    przejąć szarży modelu, który wykonał Widmowy Ruch).`,
    ],
    6: [
      "7 KLĄTWA KNIEI",
      "RZUCONY NA 10+, POZOSTAJE W GRZE",
      `Klątwa Kniei ma zasięg 24” i po udanym rzuceniu może zostać skierowana na
    pojedynczy model przeciwnika, także związany walką wręcz (wybrany przez kierującego
    MAGIEM gracza bez ograniczeń, z wyjątkiem tego, że Mag Leśnych Elfów musi widzieć
    swój cel). Dopóki zaklęcie 'pozostaje w grze' ofiara klątwy oraz wszystkie sprzymierzone
    ...
    8: [
      ...
      "RZUCONY NA 11+",
      `Ptaki Ciernistych Krzewów są niezwykle niebezpiecznym magicznym pociskiem o zasięgu 24”.
    Po udanym rzuceniu zaklęcia należy użyć 3” okrągłego wzornika i przykryć nim
    wybrany na cel model przeciwnika. Wszystkie modele (wrogie i sprzymierzone),
    których podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem
    zaklęcia automatycznie, te modele, których podstawki są częściowo przykryte, dostają
    się pod działanie zaklęcia na 4+. Objęte działaniem zaklęcia modele otrzymują trafienie
    o SILE 4 z cechą oręża PRECYZYJNE UDERZENIE.`,
    ],
    9: [
      "10 ZBROJA PÓŁMROKU",
      "RZUCONY NA 12+, POZOSTAJE W GRZE",
      `Dopóki zaklęcie ‘pozostaje w grze’ MAG otrzymuje Magiczną Ochronę na 4+. Ponadto,
    wszystkie modele (wrogie i sprzymierzone) znajdujące się w kontakcie z podstawką
    Maga Leśnych Elfów, na początku fazy walki wręcz otrzymują jedno trafienie o SILE 4 z cechą
    ...
    10: [
      ...
      `MAG może rzucić zaklęcie na siebie. Dopóki zaklęcie ‘pozostaje w grze’ magiczne ostrze
    z cechą oręża PRECYZYJNE UDERZENIE oraz premia +3 do SIŁY materializuje się w dłoni
    MAGA. Ponadto, Mag Leśnych Elfów władający Ostrzem Półmroku otrzymuje dodatkowy
    +1 ATAK, a wszystkie ciosy trafiają na 4+. Póki MAG włada magicznym orężem może
    korzystać tylko z Ostrza Półmroku - magicznego oręża nie można łączyć z inną bronią.`,
    ],
    11: [
      "12 FURIA KNIEI",
      "RZUCONY NA 13+, POZOSTAJE W GRZE",
  ...
  "Wysoka Magia": {
    ...
    aby wskazywała wynik ‘1’. Dopóki zaklęcie 'pozostaje w grze', na początku każdej
    kolejnej fazy magii MAGA należy obracać kostkę tak, by wskazywała wynik o +1 większy.
    Wynik na kostce oznacza ujemny modyfikator do współczynników SZ, S i WT jaki
    ...
    których podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem
    zaklęcia automatycznie, te modele, których podstawki są częściowo przykryte, dostają
    się pod działanie zaklęcia na 4+. Objęte działaniem zaklęcie modele otrzymują
    automatyczne trafienie o SILE 3 z cechą oręża PŁONĄCY ATAK. Ponadto, jeśli na początku
    następnej fazy magii gracza Elfów Wysokiego Rodu z Ulthuanu zaklęcie nadal 'pozostaje w
  ...
  "Mroczna Magia": {
    ...
    wręcz. Dopóki zaklęcie 'pozostaje w grze' ofiara zaklęcia zamienia się w żywą bombę,
    która na życzenie MAGA eksploduje w wybranej przez gracza fazie strzelania. Model,
    który eksplodował zostaje automatycznie Wyłączony z akcji!, a następnie należy użyć 3”
    okrągłego wzornika, którego środek należy umieścić w miejscu eksplozji ofiary zaklęcia.
    Wszystkie modele (wrogie i sprzymierzone), których podstawki są całkowicie przykryte
    wzornikiem, zostają objęte działaniem zaklęcia automatycznie, te modele, których
  ...
  "Dziedzina Chaosu Niepodzielonego": {
    ...
    że model traci 1 punkt ŻW bez możliwości skorzystania z Ochrony Pancerza.
    Należy zauważyć, że zaklęcie może zostać także skierowane na pojedynczy model
    sprzymierzeńca wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    ...
    Następnie należy wykonać rzut K6, aby określić jaki wpływ na model miała
    energia Dhar. Wynik 1 oznacza, że moc zaklęcia zatruwa model, a ofiara zostaje
    natychmiast Wyłączona z akcji!; wynik 2-5 oznacza, że dopóki zaklęcie 'pozostaje w grze'
  ...
  "Dziedzina Nurgla": {
    ...
    podstawki są całkowicie przykryte wzornikiem, zostają objęte działaniem zaklęcia
    automatycznie, te modele, których podstawki są częściowo przykryte, dostają się pod
    działanie zaklęcia na 4+. Objęte działaniem zaklęcia modele muszą wykonać test WT.
    Nieudany test oznacza, że model traci 1 punkt ŻW bez możliwości skorzystania z
    Ochrony Pancerza.
    Należy zauważyć, że zaklęcie może zostać także skierowane na model
    sprzymierzeńca wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych), który został naznaczony Piętnem
    Nurgla. Model taki automatycznie zdaje test WT, ponadto natychmiast odzyskuje
    wszystkie utracone punkty ŻYWOTNOŚCI, a jeśli model był Powalony na ziemię! lub
    ...
    sprzymierzone z postacią modele w odległości do 6” nie mogą biegać, ponadto wartość
    ...
    kostkę, tak aby wskazywała wynik ‘1’. Dopóki zaklęcie 'pozostaje w grze', na początku
    każdej kolejnej fazy magii MAGA należy obracać kostkę tak, by wskazywała wynik o +1
  ...
  "Dziedzina Slaanesha": {
    ...
    rozgrywania fazy ruchu porusza się o K3” w losowo określonym kierunku (w przypadku
    ...
    widzieć swój cel). Dopóki zaklęcie 'pozostaje w grze' ofiara klątwy oraz wszystkie
    sprzymierzone z postacią modele w odległości do 6” podlegają zasadzie specjalnej
    ...
    wzornikiem, zostają objęte działaniem zaklęcia automatycznie, te modele, których
    podstawki są częściowo przykryte, dostają się pod działanie zaklęcia na 4+. Dopóki
    zaklęcie ‘pozostaje w grze’ objęte działaniem klątwy modele nie mogą wykonać żadnego
    ruchu, rzucać zaklęć oraz strzelać. Ponadto, wszystkie ATAKI wymierzone w poddane
  ...
  "Dziedzina Tzeentcha": {
    ...
    działaniem zaklęcia automatycznie, te modele, których podstawki są częściowo
    przykryte, dostają się pod działanie zaklęcia na 4+. Objęte działaniem zaklęcia modele
  ...
  "Dziedzina Hashuta": {
    ...
    żadnego wroga, porusza się dokładnie o K6” na wprost. Jeżeli ruch taki prowadzi do
  ...
  "Dziedzina Dziczy": {
    ...
    zaklęcia model nie widzi żadnego wroga, porusza się dokładnie o K6” na wprost. Jeżeli
    ruch taki prowadzi do kontaktu z wrogiem, to jest to równoznaczne z szarżą –
  ...
  "Dziedzina Nekromancji": {
    ...
    na cel sprzymierzony model stronnika, który został Wyłączony z akcji!. Wszystkie
    sprzymierzone modele, których podstawki są całkowicie przykryte wzornikiem, zostają
    objęte działaniem zaklęcia automatycznie, te modele, których podstawki są częściowo
    przykryte, dostają się pod działanie zaklęcia na 4+. Za każdy objęty działaniem zaklęcia
    sprzymierzony model stronnika, który został Wyłączony z akcji! należy wykonać rzut K6.
    Wynik 4+ oznacza, że model natychmiast powstaje z martwych i kontynuuje turę
    ...
    walką wręcz. Dopóki zaklęcie 'pozostaje w grze' ofiara zaklęcia zamienia się w nieżywą
    bombę, która na życzenie MAGA eksploduje w wybranej przez gracza fazie strzelania.
    Model, który eksplodował zostaje automatycznie Wyłączony z akcji!, a następnie należy
    użyć 3” okrągłego wzornika, którego środek należy umieścić w miejscu eksplozji ofiary
    zaklęcia. Wszystkie modele (wrogie i sprzymierzone), których podstawki są całkowicie
    przykryte wzornikiem, zostają objęte działaniem zaklęcia automatycznie, te modele,
    których podstawki są częściowo przykryte, dostają się pod działanie zaklęcia na 4+.
  ...
  "Tradycja Skrytości": {
    ...
    PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych), również związany walką wręcz.
    Dopóki zaklęcie 'pozostaje w grze' model wydaje się znajdować kilka kroków od
    swojej prawdziwej pozycji, a wszystkie ataki (zarówno w fazie strzelania jak i w fazie walki
    wręcz) wymierzone w poddany działaniu zaklęcia model wykonywane są z karą -1 do
    rzutu na trafienie.
    `],
  ...
  "Tradycja Zarazy": {
    ...
    postacią modele w odległości do 6” nie mogą biegać, ponadto wartość współczynnika
  ...
  "Magia Małego Łooomotu!": {
    ...
    PIESZY model wielkości człowieka lub mniejszy (czar nie będzie zatem działał na
    modele na podstawkach 40x40 mm i większych), również związany walką wręcz.
    Dopóki zaklęcie 'pozostaje w grze' ofiara zaklęcia zamienia się w żywą bombę, która na
    życzenie MAGA eksploduje w wybranej przez gracza fazie strzelania. Model, który
    eksplodował zostaje automatycznie Wyłączony z akcji!, a następnie należy użyć 3”
    okrągłego wzornika, którego środek należy umieścić w miejscu eksplozji ofiary zaklęcia.
    Wszystkie modele (wrogie i sprzymierzone), których podstawki są całkowicie przykryte
    wzornikiem, zostają objęte działaniem zaklęcia automatycznie, te modele, których
    podstawki są częściowo przykryte, dostają się pod działanie zaklęcia na 4+. Objęte
  ...
  "Magia Dużego Łooomotu!": {
    ...
    Ochronę wykonanych przez ofiarę klątwy oraz wszystkie sprzymierzone z postacią
    modele w odległości do 6” uznana będzie za 1. Jeżeli pod wpływem zaklęcia znajdzie
  ...
  "Magia Pradawnych": {
    ...
    wyjątkiem samego rzucającego!). Objęte działaniem zaklęcia modele otrzymują trafienie
    o SILE 4 z cechą oręża PŁONĄCY ATAK.
    W najbliższej fazie ruchu model Kapłana Skinków powstaje podczas wykonywania
    pozostałych ruchów, tak jak postać która była Oszołomiona!. MAG może wykonać ruch (ale
    nie bieg), rzucać zaklęcia oraz strzelać. Jeśli model pozostaje związany walką wręcz to
    końca trwania tury w której powstał, będzie UDERZAŁ JAKO OSTATNI, bez względu na
    wartość I, oręż którym walczy lub inne zasady specjalne. Ponadto od momentu powstania
